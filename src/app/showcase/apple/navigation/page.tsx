...
import { LayoutDashboard, History, Settings, Bell, Search } from "lucide-react";

export default function NavigationShowcase() {
  return (
    <div className="space-y-12">
      <div>
        <p className="apple-caption text-muted-foreground">Navigation</p>
        <h1 className="apple-section mt-1">내비게이션</h1>
        <p className="apple-body mt-2 text-muted-foreground">5 components</p>
      </div>
      ...
      >
        <div className="space-y-4">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/showcase/apple">Apple Showcase</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/showcase/apple/navigation">Navigation</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
        ...
        <Tabs defaultValue="all">
          ...
          <TabsContent value="up">
            <div className="mt-4 space-y-2">
              {[
                ...
                >
                  <span className="apple-body font-medium">{item.name}</span>
                  <span className="apple-body" style={{ color: "#34c759" }}>
                    {item.change}
                  </span>
                </div>
              ))}
          ...
          <TabsContent value="down">
            <div className="mt-4">
              <div className="flex items-center justify-between rounded-xl bg-card px-4 py-3">
                <span className="apple-body font-medium">SK하이닉스</span>
                <span className="apple-body" style={{ color: "#ff3b30" }}>
                  -1.89%
                </span>
              </div>
            </div>
          ...
          <TabsContent value="hold">
            <div className="mt-4 flex flex-col items-center py-8">
              <p className="apple-body text-muted-foreground">보합 종목 없음</p>
            </div>
          </TabsContent>
        </Tabs>
      </ComponentSection>
