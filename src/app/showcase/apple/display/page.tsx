...
const chartConfig = {
  alerts: { label: "등록 알림", color: "#0071e3" },
  triggered: { label: "발동 알림", color: "#34c759" },
...
export default function DisplayShowcase() {
  return (
    <div className="space-y-12">
      <div>
        <p className="apple-caption text-muted-foreground">Data Display</p>
        <h1 className="apple-section mt-1">데이터 표시</h1>
      ...
      >
        <Table>
          <TableCaption className="apple-caption">최근 발동 알림 이력</TableCaption>
          <TableHeader>
            <TableRow>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="apple-body font-medium">홍길동</p>
              <p className="apple-caption text-muted-foreground">hong@example.com</p>
            </div>
          </div>
        </div>
      </ComponentSection>
      ...
      >
        <Accordion className="w-full max-w-md">
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="apple-body text-muted-foreground">
                ...
                <CarouselItem key={item.code}>
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="apple-body">{item.title}</CardTitle>
                      <p className="apple-caption text-muted-foreground">{item.code}</p>
                    </CardHeader>
                    <CardContent>
                      <p className="apple-tile font-semibold">{item.price}</p>
                      <p
                        className="apple-caption mt-1"
