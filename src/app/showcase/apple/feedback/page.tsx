...
export default function FeedbackShowcase() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <p className="apple-caption text-muted-foreground">Feedback & Status</p>
        <h1 className="apple-section mt-1">피드백 & 상태</h1>
        ...
        <div className="space-y-4 max-w-sm">
          <div className="space-y-2">
            <div className="flex justify-between">
              <p className="apple-caption text-muted-foreground">데이터 로딩</p>
              <p className="apple-caption text-muted-foreground">{progress}%</p>
            </div>
            <Progress value={progress} />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between">
              <p className="apple-caption text-muted-foreground">알림 한도 사용량</p>
              <p className="apple-caption text-muted-foreground">6 / 10</p>
            </div>
            <Progress value={60} />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between">
              <p className="apple-caption text-muted-foreground">오늘 발동률</p>
              <p className="apple-caption text-muted-foreground">3 / 5</p>
            </div>
            <Progress value={100} />
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="apple-caption text-muted-foreground">Small</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Loader2 className="h-6 w-6 animate-spin text-primary" />
            <p className="apple-caption text-muted-foreground">Default</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Loader2 className="h-8 w-8 animate-spin text-primary" />
            <p className="apple-caption text-muted-foreground">Large</p>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Loader2 className="h-10 w-10 animate-spin text-muted-foreground" />
            <p className="apple-caption text-muted-foreground">Muted</p>
          </div>
          <Button disabled>
      ...
      >
        <div className="space-y-6">
          <div>
            <p className="apple-caption mb-3 text-muted-foreground">알림 카드 스켈레톤</p>
            <div className="space-y-3">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
          ...
          <div>
            <p className="apple-caption mb-3 text-muted-foreground">프로필 스켈레톤</p>
