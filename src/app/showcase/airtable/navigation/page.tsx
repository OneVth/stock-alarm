...
export default function NavigationShowcase() {
  return (
    <div className="space-y-12">
      <div>
        <p className="at-caption text-muted-foreground">Navigation</p>
        <h1 className="at-section mt-1">내비게이션</h1>
        <p className="at-body mt-2 text-muted-foreground">5 components</p>
      </div>
      ...
      >
        <div className="space-y-4">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/showcase/airtable">Airtable Showcase</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/showcase/airtable/navigation">Navigation</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
        ...
        <Tabs defaultValue="all">
          ...
          <TabsContent value="up">
            <div className="mt-4 space-y-2">
              {[
                ...
                >
                  <span className="at-body font-medium">{item.name}</span>
                  <span className="at-body" style={{ color: "#16a34a" }}>
                    {item.change}
                  </span>
                </div>
              ))}
          ...
          <TabsContent value="down">
            <div className="mt-4">
              <div className="flex items-center justify-between rounded-xl border border-border bg-card px-4 py-3">
                <span className="at-body font-medium">SK하이닉스</span>
                <span className="at-body" style={{ color: "#dc2626" }}>
                  -1.89%
                </span>
              </div>
            </div>
          ...
          <TabsContent value="hold">
            <div className="mt-4 flex flex-col items-center py-8">
              <p className="at-body text-muted-foreground">보합 종목 없음</p>
            </div>
          </TabsContent>
        </Tabs>
      </ComponentSection>
