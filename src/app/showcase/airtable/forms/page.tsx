...
export default function FormsShowcase() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <p className="at-caption text-muted-foreground">Data Input / Forms</p>
        <h1 className="at-section mt-1">폼 & 입력</h1>
        <p className="at-body mt-2 text-muted-foreground">14 components</p>
      </div>

      <ComponentSection
        title="Button"
        description="variant별 (default, outline, ghost, destructive, link) + size별 + Airtable Blue CTA"
      >
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button className="at-cta">
              알림 등록
            </Button>
            <Button variant="outline" className="at-cta">
              자세히 보기
            </Button>
          </div>
        </div>
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="at-caption text-destructive">
              올바른 이메일 형식이 아닙니다.
            </p>
          </div>
        </div>
      ...
      >
        <div className="space-y-4">
          <div>
            <p className="at-caption mb-2 text-muted-foreground">정렬 (단일)</p>
          ...
          <div>
            <p className="at-caption mb-2 text-muted-foreground">서식 (다중)</p>
